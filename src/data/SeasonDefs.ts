...
export const SEASON_DATA: SeasonData[] = [
  { name: 'Early Spring',  temperature: 5,   cropGrowth: 0,   gatheringRate: 0.5, snow: false, dayLength: 0.5 },
  { name: 'Mid Spring',    temperature: 12,  cropGrowth: 0.5, gatheringRate: 0.8, snow: false, dayLength: 0.6 },
  ...
  { name: 'Mid Autumn',    temperature: 10,  cropGrowth: 0,   gatheringRate: 0.5, snow: false, dayLength: 0.5 },
